...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_F2] = LAYOUT_83_ansi( /* FN */
        LCD_TOGG,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
    ...
    [MAC_F] = LAYOUT_83_ansi( /* FN */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          LCD_ENTER,        _______,
        _______,          _______, _______, _______, _______, _______, _______, SW_OS1, LCD_LEFT,LCD_RIGHT,_______, _______,          RM_VALU, _______,
