...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_64( /* FN */
        ...
        _______,    _______, MO(MAC_EX), _______,                MO(MAC_EX),                _______, MO(MAC_EX), _______, KC_PGDN, _______),
    ...
    [WIN_FN] = LAYOUT_ansi_64( /* FN */
        ...
        _______,    _______, MO(WIN_EX), _______,                MO(WIN_EX),                _______, MO(WIN_EX), _______, KC_PGDN, _______),
