...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_86_ansi(
        ...
        _______, _______,  _______, _______,  _______,  _______,  _______, _______, SW_OS,   _______, _______, _______,  _______,                       BL_VALU,
    ...
    [MAC_FN] = LAYOUT_86_ansi(
        ...
        _______, _______,  _______, _______,  _______,  _______,  _______, _______, _______, _______, _______, _______,             _______,
        _______, _______,  _______, _______,  _______,  _______,  _______, _______, _______, _______, _______, _______,   _______,                      BL_VALU,
