...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_64( /* FN */
        ...
        _______,             _______, _______, _______, _______, _______, SW_OS1,  _______, _______, _______, _______, KC_PGUP, _______,
        _______,    _______, MO(MAC_EX), _______,                MO(MAC_EX),                _______, _______, _______, KC_PGDN, _______),
    ...
    [MAC_EX] = LAYOUT_ansi_64( /* FN */
        ...
        _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,             _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, _______,
    ...
    [WIN_FN] = LAYOUT_ansi_64( /* FN */
        ...
        _______,    BT_HOST1,BT_HOST2,BT_HOST3,BT_2_4G, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,             _______, _______, _______, _______, _______, _______, SW_OS1,  _______, _______, _______, KC_PGUP, _______,
        _______,    _______, MO(WIN_EX), _______,                MO(WIN_EX),                _______, _______, _______, KC_PGDN, _______),
