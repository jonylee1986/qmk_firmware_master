...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_86_ansi(
        ...
        _______, _______,  _______,      _______,  _______,  _______,  _______, _______, _______,       _______, _______, _______,  _______,  _______,   RM_NEXT,  RM_HUEU,  _______,
        _______, _______,  _______,      _______,  _______,  _______,  _______, _______, _______,       _______, _______, _______,  _______,  _______,   _______,  _______,  _______,
        _______, _______,  _______,      _______,  _______,  _______,  _______, _______, _______,       _______, _______, _______,            _______,
        _______,           _______,      _______,  _______,  _______,  _______, _______, PDF(MAC_BASE), _______, _______, _______,  _______,                       RM_VALU,
    ...
    [MAC_FN] = LAYOUT_86_ansi(
        ...
        _______, _______,  _______,      _______,  _______,  _______,  _______, _______, _______,       _______, _______, _______,   _______,  _______,  RM_NEXT,  RM_HUEU,  _______,
        _______, _______,  PDF(WIN_BASE),_______,  _______,  _______,  _______, _______, _______,       _______, _______, _______,   _______,  _______,  _______,  _______,  _______,
        _______, _______,  _______,      _______,  _______,  _______,  _______, _______, _______,       _______, _______, _______,             _______,
