...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi(
        ...
        _______, BT_HOST1,BT_HOST2,BT_HOST3,BT_2_4G, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG,          _______, _______, _______, _______,
        RGB_WHI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_MOD,          _______, _______, _______, _______,
        _______, _______, SW_OS1,  _______, _______, _______, _______, _______, _______, _______, _______, _______,          RGB_HUI,          _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,                   _______, RGB_VAI, _______, _______, _______, _______, 
        _______, GU_TOGG, _______,                            _______,                                     _______, BT_VOL,  RGB_SPD, RGB_VAD, RGB_SPI, _______, _______ 
    ),
    ...
    [MAC_FN] = LAYOUT_ansi(
        ...
        _______, BT_HOST1,BT_HOST2,BT_HOST3,BT_2_4G, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG,          _______, _______, _______, _______,
        RGB_WHI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_MOD,          _______, _______, _______, _______,
        _______, SW_OS1,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          RGB_HUI,          _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,                   _______, RGB_VAI, _______, _______, _______, _______,
        _______, _______, _______,                            _______,                                     _______, BT_VOL,  RGB_SPD, RGB_VAD, RGB_SPI, _______, _______
    ),
    ...
    switch (keycode) {
        case ENC_CMSP:{
            if (record->event.pressed) {
                if (dynamic_keymap_get_keycode(0, 3, 18) == RGB_MOD) {                 //获取某层键值
                    dynamic_keymap_set_keycode(0, 3, 18, KC_MUTE);
                    dynamic_keymap_set_keycode(2, 3, 18, KC_MUTE);      
                }else{
                    dynamic_keymap_set_keycode(0, 3, 18, RGB_MOD);
                    dynamic_keymap_set_keycode(2, 3, 18, RGB_MOD);
        ...
        // case DF(0):
        //     if (record->event.pressed) {
        //         OS_press_time = timer_read32();         //记录按键按下的时间（32 位）
        //         OS_blink_time = timer_read();          
        //         OS_blink_index = 55;
